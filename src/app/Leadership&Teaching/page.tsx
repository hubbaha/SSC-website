                  ...
                  <div className="relative">
                    <div className="text-left mb-8">
                      ...
                      <p className="text-base sm:text-lg text-gray-700">
                        In the heart of Kashmir, the Sufi Science Center merges
                        ancient Sufi wisdom with modern science, guiding seekers
                        on a transformative journey of spiritual awakening and
                        intellectual discovery. Through sacred teachings and
                        spiritual leadership, we illuminate the path to inner
                        harmony, universal truth, and collective growth.
                      </p>
                    </div>
                    <ul className="space-y-6 sm:space-y-8 lg:space-y-10">
                      ...
                      <li className="relative flex items-center p-6 py-6 md:py-8 bg-white rounded-lg shadow-md  transition-all duration-500 hover:-translate-y-[10px] group">
                        ...
                        <div className="ml-4 sm:ml-6">
                          ...
                          <p className="text-sm sm:text-base text-gray-700 transition-colors duration-500 ">
                            Sufi science integrates intellect and
                            evolution.{" "}
                          </p>
                        </div>
                      </li>
                ...
                <div className="w-full lg:w-8/12">
                  <div className="relative block">
                    <div className="text-left">
                      ...
                      <p className="text-base sm:text-lg text-gray-700">
                        Sufi leadership embodies humility, service, and
                        compassion, guiding others through inner wisdom and
                        divine grace. Our programs inspire individuals to
                        nurture their spiritual growth, fostering
                        interconnectedness and selfless service.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mb-[52px]">
                  ...
                  <div className="md:w-1/2 lg:w-7/12 pt-[123px] relative">
                    <div className="mb-[24px]">
                      <h4 className="text-[30px] font-semibold leading-[40px]  mb-[14px]">
                        {" "}
                        Illuminating the Path to Divine Presence
                      </h4>
                      <p>
                        Like a quiet lamp, a Sufi leader illuminates the path to
                        divine presence, helping others discover the sacredness
                        in all things.
                      </p>
                    </div>
                    <ul className="space-y-[17px] pb-[17px]">
                      <li className="flex justify-between border-b border-gray-300 pb-[17px]">
                        <div>
                          ...
                          <p>
                            Sufi leaders empower others through humble service,
                      ...
                      <li className="flex justify-between border-b border-gray-300 pb-[17px]">
                        <div>
                          ...
                          <p>
                            Leaders guide through inner wisdom, shaped by divine
                            grace and insight.
                          </p>
                        </div>
                      </li>
                      <li className="flex justify-between border-b border-gray-300 pb-[17px]">
                        <div>
                          ...
                          <p>
                            Nurturing others' souls with love and patience for
                            spiritual growth.
                          </p>
                        </div>
                      </li>
                      <li className="flex justify-between border-b border-gray-300 pb-[17px]">
                        <div>
                          ...
                          <p>
                            Our programs inspire service through knowledge,
                            wisdom, and selfless actions.
                          </p>
                        </div>
                      </li>
                    </ul>
                ...
                <div className="flex flex-col pl-5 md:flex-row  bg-gray-100 p-0 pb-[52px] mb-[110px] relative z-10">
                  <div className="md:w-1/2 lg:w-7/12 pt-[123px] relative">
                    <div className="mb-[24px]">
                      <h4 className="text-[30px] font-semibold leading-[40px] mb-[14px]">
                        Teaching as a Sacred Art
                      </h4>
                      <p>
                        Teaching awakens souls, unites spiritual wisdom with
                        modern understanding and growth.
                      </p>
                    </div>
                    <ul className="space-y-[17px] pb-[17px]">
                      <li className="flex justify-between border-b border-gray-300 pb-[17px]">
                        <div>
                          ...
                          <p>
                            Teaching in Sufism awakens the soul, helping others
                            see the unseen .
                          </p>
                        </div>
                      </li>
                      <li className="flex justify-between border-b border-gray-300 pb-[17px]">
                        <div>
                          ...
                          <p>
                            We blend Sufi spiritual practices with modern
                            science to foster deep understanding.
                          </p>
                        </div>
                      </li>
                      <li className="flex justify-between border-b border-gray-300 pb-[17px]">
                        <div>
                          ...
                          <p>
                            Our courses and workshops illuminate ancient truths
                            through contemporary scientific insights.
                          </p>
                        </div>
                      </li>
                      <li className="flex justify-between border-b border-gray-300 pb-[17px]">
                        <div>
                          ...
                          <p>
                            We teach how to integrate spiritual practices like
                            dhikr and meditation into daily life.
                          </p>
                        </div>
                      </li>
                    </ul>
            ...
            <div className="relative block">
              <div className=" text-center mb-[42px]">
                ...
                <p className="pt-[15px] sm:pt-[20px] text-gray-100 text-[14px] sm:text-[16px] md:text-[18px] leading-[22px] sm:leading-[26px] md:leading-[30px]">
                  In the rich tradition of Kashmiri Sufism, we offer a space
                  where leadership is born from service, where teaching is
                  rooted in love, and where the journey of the soul is
                  illuminated by the divine light of truth. This is an
                  invitation to step into a world where the sacred & scientific
                  are one, where you are not only a seeker but also a guide for
                  others, and where your personal journey is deeply intertwined
                  with collective journey of humanity. Awaken your soul, expand
                  your consciousness, and become a leader of the divine sciences
                  in the land where mysticism and science meet.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="text-center mb-[49px]">
              ...
              <p className="s pt-[20px]">
                Empowering youth to integrate spirituality with science, our
                programs foster leaders who will inspire positive
                transformation, bridging the material and spiritual realms for
                holistic growth.
              </p>
            </div>
                ...
                <div className="relative block bg-white shadow-[0_8px_29px_0_rgba(0,0,0,0.1)] mb-[30px] z-[2]">
                  ...
                  <div className="p-[22px] pb-[30px]">
                    ...
                    <p className="mt-[15px] mb-[22px]">
                      We combine ancient spiritual teachings with modern
                      scientific exploration to guide transformative leaders.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="relative block bg-white shadow-[0_8px_29px_0_rgba(0,0,0,0.1)] mb-[30px] z-[2]">
                  ...
                  <div className="p-[22px] pb-[30px]">
                    ...
                    <p className="mt-[15px] mb-[22px]">
                      Our programs instill a sense of responsibility to
                      understand and nurture both the physical and spiritual
                      realms.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="relative block bg-white shadow-[0_8px_29px_0_rgba(0,0,0,0.1)] mb-[30px] z-[2]">
                  ...
                  <div className="p-[22px] pb-[30px]">
                    ...
                    <p className="mt-[15px] mb-[22px]">
                      We empower individuals to explore the mysteries of the
                      universe, revealing the divine truths behind all that
                      exists.
                    </p>
                  </div>
                </div>
