              ...
              <div className="col-lg-6 col-xl-6">
                ...
                <div className="product-details__buttons">
                  <div className="product-details__buttons-1">
                    <Link href="product-details" className="thm-btn">
                      Add to Wishlist
                    </Link>
                  </div>
          ...
          <div className="container">
            ...
            <div className="product-description__list">
              <ul className="list-unstyled">
                <li>
                  <p>
                    <span className="icon-right-arrow"></span> Nam at elit nec
                    neque suscipit gravida.
                  </p>
                </li>
                <li>
                  <p>
                    <span className="icon-right-arrow"></span> Aenean egestas
                    orci eu maximus tincidunt.
                  </p>
                </li>
                <li>
                  <p>
                    <span className="icon-right-arrow"></span> Curabitur vel
            ...
            <div className="comments-area">
                ...
                <div className="comment">
                  <div className="author-thumb">
                    <figure className="thumb">
                      <img src="assets/images/shop/review-1-1.jpg" alt="" />
                    </figure>
                  </div>
                  ...
                  <div className="review-one__content">
                    <div className="review-one__content-top">
                      <div className="info">
                        <h2>
                          Kevin martin <span>20 july 2023 . 4:00 pm</span>
                        </h2>
                      </div>
                    ...
                    <div className="review-one__content-bottom">
                      <p>
                        ...
                        simply free text. className aptent taciti sociosqu ad
              ...
              <div className="comment-box">
                <div className="comment">
                  <div className="author-thumb">
                    <figure className="thumb">
                      <img src="assets/images/shop/review-1-2.jpg" alt="" />
                    </figure>
                  </div>
                  ...
                  <div className="review-one__content">
                    <div className="review-one__content-top">
                      <div className="info">
                        <h2>
                          Sarah albert <span>20 july 2023 . 4:00 pm</span>
                        </h2>
                      </div>
                      <div className="reply-btn">
                        <i className="fa fa-star"></i>
