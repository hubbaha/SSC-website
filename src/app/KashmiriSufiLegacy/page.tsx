          ...
          <div className="container mx-auto px-4">
            <div className="text-center relative block mt-[-6px] mb-[49px] z-[1]">
              ...
              <h2 className="mt-[14px] text-fixnix-darkpurple text-[28px] sm:text-[36px] md:text-[42px] leading-[40px] sm:leading-[48px] md:leading-[52px] font-semibold">
                A Journey through the Mystical Heritage of Kashmir
              </h2>
              ...
              <p className="pt-[20px] text-left text-gray-600 text-sm sm:text-base md:text-md lg:text-lg leading-[1.8] sm:leading-[2] md:leading-[1.5]">
                Kashmir’s Sufi heritage blends spiritual wisdom, poetry, music,
                and sacred sciences, transcending time & place. Mystics like
                Shah Hamdan and Nund Rishi teach self-realization as an
                ever-present reality. This legacy views the world as
                interconnected through the divine breath, shaping Kashmir’s
                spirituality, art, & philosophy. Rooted in unity, it inspires
                coexistence, illuminating the bond between humanity, nature, &
                the Divine
              </p>
            </div>
          </div>
          ...
          <div className="container mx-auto">
            ...
            <div className="text-center mb-[57px]">
              ...
              <h2 className="mt-[14px] text-white text-[24px] sm:text-[32px] md:text-[42px] leading-[32px] sm:leading-[40px] md:leading-[52px] font-semibold">
                Ancient wisdom traditions emphasize spiritual growth, balance, &
                exploration
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px]">
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Ancient Sufis harmonized spiritual truths with the natural
                    world's intricate divine patterns and cosmic order.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Kashmir Sufis embraced sacred geometry and astrology,
                    intertwining them with spiritual practices and insights.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Merging Sufi wisdom with scientific thought provides
                    profound insights into consciousness, universe & nature.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="relative">
                  <div className="text-left mb-8">
                    ...
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mt-4 mb-6 leading-snug sm:leading-tight">
                      Kashmiri Sufi legacy fosters peace, harmony, and cultural
                      exchange
                    </h2>
                    <p className="text-base sm:text-lg text-gray-700">
                      Kashmiri Sufism shaped the region’s social and cultural
                      fabric, fostering unity, peace, and tolerance. Its
                      spiritual centers promoted learning, cultural exchange,
                      and social service, leaving a lasting legacy in
                      literature, art, and architecture.Through its influence,
                      Kashmiri Sufism remains an integral part of the region’s
                      historical narrative, offering a beacon of hope and a path
                      to healing.
                    </p>
                  </div>
        ...
        <section className=" text-left-mobile relative block bg-fixnix-darkpurple py-[120px] z-[1]">
          ...
          <div className="container mx-auto">
            ...
            <div className="text-center mb-[57px]">
              ...
              <h2 className="mt-[14px] text-white text-[24px] sm:text-[32px] md:text-[42px] leading-[32px] sm:leading-[40px] md:leading-[52px] font-semibold">
                A peaceful sanctuary merging spirituality, science, growth, &
                self-discovery
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px]">
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Committed to preserving and sharing Kashmir’s enduring
                    mystical insights and bridging them with science.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Discover Sufi teachings on consciousness, existence, and
                    profound connections between inner and outer worlds.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Uniting seekers, scientists, and philosophers through
                    ancient wisdom and modern scientific exploration.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center relative block mt-[-6px] mb-[40px] sm:mb-[49px] z-[1]">
              ...
              <p className="pt-[15px] sm:pt-[20px] text-center xs:text-left sm:text-left md:text-center lg:text-center text-gray-600 text-[14px] sm:text-[16px] md:text-[18px] leading-[22px] sm:leading-[26px] md:leading-[30px]">
                The Kashmir Sufi Legacy transcends borders, inspiring
                transformation globally. Through our educational programs,
                spiritual practices, and scientific research, we invite you to
                experience the timeless wisdom that continues to illuminate the
                hearts and minds of all who seek truth . Welcome to a
                transformative journey that will profoundly deepen your
                understanding of the vast mysteries of the universe and the
                divine.
              </p>
