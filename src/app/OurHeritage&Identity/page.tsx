          ...
          <div className="container mx-auto px-4">
            <div className="text-center sm:text-left relative block mt-[-6px] mb-[49px] z-[1]">
              ...
              <p className="pt-[20px] text-center text-gray-600 text-sm sm:text-base md:text-md lg:text-lg leading-[1.8] sm:leading-[2] md:leading-[1.5]">
                Our heritage is built upon the principles of Wahdat al-Wujud,
                where all creation, from the smallest grain of sand to the
                grandest galaxies, is seen as a manifestation of the Divine.
                Within this sacred understanding, Sufi science roots itself in
                recognizing the interconnectedness of all things. This bridges
                ancient spiritual traditions of Kashmir and the modern
                scientific quest to understand laws of nature, and energy.
              </p>
            </div>
          </div>
        </section>
...
"
              >
                How Kashmiri Sufism blends cultural heritage, scientific
                inquiry, & wisdom?
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px]">
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    ...
                    laws, blending divine wisdom with intellectual pursuits.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Kashmiri Sufi teachings inspire harmony, self-awareness, and
                    a profound balance between spiritual and intellectual
                    growth.
                  </p>
                </div>
              </div>
                ...
                <div className="relative">
                  <div className="text-left mb-8">
                    ...
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mt-4 mb-6 leading-snug sm:leading-tight">
                      Fusing spirituality, culture, science, and Kashmir’s
                      legacy
                    </h2>
                    <p className="text-base sm:text-lg text-gray-700">
                      The Kashmiri Sufi Center blends spirituality, culture, and
                      intellectual exploration, rooted in historical heritage.
                      It integrates divine wisdom with scientific curiosity,
                      promoting self-awareness, love, and compassion. Through
                      workshops and research, it preserves Kashmiri Sufi
                      teachings, uniting ancient wisdom with modern
                      understanding.
                    </p>
                  </div>
                  <ul className="space-y-6 sm:space-y-8 lg:space-y-10">
                    ...
                    <li className="relative flex items-center p-6 py-6 md:py-8 bg-white hover:-translate-y-[10px] group rounded-lg shadow-md  transition-all duration-500">
                      ...
                      <div className="ml-4 sm:ml-6">
                        ...
                        <p className="text-sm sm:text-base text-gray-700 transition-colors duration-500 ">
                          Spirituality blends science and mysticism.
                        </p>
                      </div>
                    </li>
                  </ul>
          ...
          <div className="container mx-auto">
            ...
            <div className="text-center mb-[57px]">
              ...
              <h2 className="mt-[14px] text-white text-[24px] sm:text-[32px] md:text-[42px] leading-[32px] sm:leading-[40px] md:leading-[52px] font-semibold">
                Kashmir Sufi Science Centre explores the fusion of spirituality
                & science
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px]">
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Sufi scholars revered nature’s interconnectedness, promoting
                    ecological balance, spiritual principles, harmony, and
                    unity.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Sufi ethics guided scientific pursuits, ensuring integrity,
                    truth, humanity’s welfare, and responsible exploration.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap -mx-4">
              ...
              {[
                ...
                },
                {
                  ...
                  img: "assets/images/team/team6.jpg",
                },
                {
                  name: "Wahab Khar",
                  title: "Master Technician",
                  img: "assets/images/team/team8.jpg",
                },
                {
                  name: "Nicolas Poran",
                  title: "Digital Marketing",
                ...
                <div key={idx} className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
                  <div className="relative group">
                    ...
                    <div className="absolute bottom-0 left-0 w-65 h-16 bg-white px-2 py-2 rounded-tr-lg">
                      ...
                      <p className="text-sm text-fixnix-lightpurple ">
                        {member.title}
                      </p>
                    </div>
