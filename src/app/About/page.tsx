'use client'
import CounterUp from '../../components/elements/CounterUp'; // Adjust as necessary
...
export default function About() {
    ...
    return (
       ...
       <Layout
         ...
         headTitle="About Us" // Add this
        wrapperCls="custom-wrapper" // Add this (or any class you use)
>
                ...
                <div className="row">
                    ...
                    <div className="col-xl-7 col-lg-6">
                        <div className="about-two__right">
                            ...
                            <span className="section-title__tagline color" style={{ color: '#023879', fontWeight:"bolder" }}>About Us</span>

                            <h2 className="section-title__title"> The World’s First Sufi Centre Exploring New  <span style={{ color: '#ef6d27' }}>Scientific Frontiers</span>
</h2>

                            </div>
                            <p className="about-two__text-1">At the Kashmir Sufi Science Centre, we redefine the boundaries of knowledge by merging the spiritual depth of Sufi philosophy with the limitless possibilities of science.</p>
                            <ul className="list-unstyled about-two__points">
                                <li>
                                    ...
                                    <div className="text">
                                        <p style={{ fontSize: '16px' }}>Uniting Sufi insights with groundbreaking science.</p>
                                    </div>
                                </li>
                                <li>
                                    <div className="icon">
                                    ...
                                    <div className="text">
                                        <p style={{ fontSize: '16px' }}>Transforming knowledge into impact for humanity.</p>
                                    </div>
                                </li>
                                <li>
                                    <div className="icon">
                                    ...
                                    <div className="text">
                                <p style={{ fontSize: '16px' }}>Advancing ethical, purposeful scientific exploration.</p>
                               </div>


                                </li>
                            </ul>
                            <p className="about-two__text-2">The Kashmir Sufi Science Centre stands as a global pioneer in uniting
                                 the profound wisdom of Sufism with the transformative
                                  potential of modern science. As the first institution of its kind, 
                                  we seek to uncover new scientific explorations inspired by the timeless teachings of Sufi philosophy</p>
                            <Link href="About" className="thm-btn">Read more</Link>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div className="company-details__single">
                            <div className="company-details__single-inner">
                                ...
                                <h3 className="company-details__title"  ><Link href="about" style={{color: '#023879'}}>Who We Are</Link></h3>
                                <p className="company-details__text"style={{textAlign:"left", }}>A trailblazing institution harmonizing Sufi mysticism and 
                                    scientific exploration, bridging ancient wisdom with modern knowledge.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div className="company-details__single">
                            <div className="company-details__single-inner">
                                ...
                                <h3 className="company-details__title"><Link href="about" style={{color: '#023879'}}>Our Vision</Link></h3>
                                <p className="company-details__text" style={{textAlign:"left"}}>To be a global beacon where science meets mysticism, fostering innovation 
                                    and expanding consciousness for humanity's evolution.</p>
                            </div>
                        </div>
                    </div>
                    {/*Services Two Single End*/}
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div className="company-details__single">
                            <div className="company-details__single-inner">
                                ...
                                <h3 className="company-details__title"><Link href="about" style={{color: '#023879'}}>Our Mission</Link></h3>
                                <p className="company-details__text" style={{textAlign:"left",}}>To unify Sufi mysticism and science, unlocking transformative insights and advancing humanity's 
                                    understanding through profound discovery</p>
                            </div>
                        </div>
                    </div>
                    {/*Services Two Single End*/}
