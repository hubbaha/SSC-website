    ...
    <Layout headerStyle={2} footerStyle={1} >
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            { icon: "icon-award", title: "Sufi Teachings and Lectures", desc:"Listen to timeless wisdom from Sufi masters through audio and video recordings." },
            { icon: "icon-customer-service", title: "Sacred Geometry and Art", desc:"Discover divine patterns in Sufi art, architecture, and interactive visuals." },
            { icon: "icon-security", title: "Meditative and Healing Practices", desc:"Engage in guided meditations, dhikr, and spiritual healing through sound and breath." },
            { icon: "icon-computer-1", title: "Sufi Literature and Poetry", desc:"Enjoy mystical poetry by Rumi, Bulleh Shah, and Ameer Khusro in audio/text." },
          ].map((item, index) => (
            <div
              key={index}
        ...
        <div className="w-full lg:w-8/12">
          <div className="relative block">
            ...
            Gateway to Wisdom & Transformation
              ...
              Explore the collection, listen to the teachings, watch the documentaries, and immerse yourself in the profound union of Sufi spirituality and scientific exploration. The Multimedia Library at the Sufi Learning Centre is here to support your journey of awakening and transformation.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            {[1, 2, 3, 4, 5, 6].map((item, index) => (
              <div key={index} className="relative bg-white shadow-light-purple rounded-lg overflow-hidden hover:shadow-2xl transition duration-300">
                <div className="relative overflow-hidden group">
                  <img src={`/assets/images/blog/blog-2-${item}.jpg`} alt="" className="w-full transition-transform duration-500 group-hover:scale-105" />
                  <div className="absolute inset-0 flex items-center justify-center bg-fixnix-lightpurple bg-opacity-70 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
