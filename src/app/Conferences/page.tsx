...
export default function Home() {
    ...
    const handleToggle = (key: number) => {  // Type the key parameter explicitly as number
        if (isActive.key === key) {
          setIsActive({
            status: false,
            key: isActive.key,
          ...
          setIsActive({
            status: true,
            key,  // 'key' is automatically typed as a number
          });
        }
      };
    ...
    return (
        <>
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Phone Repair">
        {/*Fixing One Start*/}
                ...
                <div className="row">
                    <div className="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div className="why-choose-one__single">
                            ...
                            <div className="why-choose-one__content">
                                <h3 className="why-choose-one__title"><Link href="/Conferences">Warranty Service</Link>
                                </h3>
                    ...
                    <div className="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <div className="why-choose-one__single">
                            ...
                            <div className="why-choose-one__content">
                                <h3 className="why-choose-one__title"><Link href="/Conferences">Customer Service</Link>
                                </h3>
                                <p className="why-choose-one__text">Duis aute irure dolor in repreh enderit in
                                    volup tate velit esse cillum dolore eu fugiat</p>
                            </div>
                    ...
                    <div className="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div className="why-choose-one__single">
                            ...
                            <div className="why-choose-one__content">
                                <h3 className="why-choose-one__title"><Link href="/Conferences">Secured Device</Link>
                                </h3>
                                <p className="why-choose-one__text">Duis aute irure dolor in repreh enderit in
                                    volup tate velit esse cillum dolore eu fugiat</p>
                            </div>
                    ...
                    <div className="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <div className="why-choose-one__single">
                            ...
                            <div className="why-choose-one__content">
                                <h3 className="why-choose-one__title"><Link href="/Conferences">No Virus Threat</Link>
                                </h3>
                                <p className="why-choose-one__text">Duis aute irure dolor in repreh enderit in
                                    volup tate velit esse cillum dolore eu fugiat</p>
                            </div>
                    ...
                    <div className="col-xl-6 col-lg-6">
                        <div className="faq-one__left">
                            ...
                            <div className="faq-one__btn-box">
                                <Link href="/Inquiries" className=" thm-btn faq-one__btn">Ask Questions Here</Link>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-6 col-lg-6">
