          ...
          <div className="container mx-auto px-4">
            <div className="text-center relative block mt-[-6px] mb-[49px] z-[1]">
              ...
              <p className="pt-[20px] text-gray-600 text-sm sm:text-base md:text-md lg:text-lg leading-[1.8] sm:leading-[2] md:leading-[1.5]">
                Our purpose is to create a sanctuary for knowledge seekers,
                where the soul’s path intertwines with scientific thought. We
                honor the sacred connection between the seen and unseen,
                understanding that true wisdom transcends disciplines. In the
                Sufi tradition, the Divine is immanent in all creation, and by
                contemplating the universe’s mysteries, we approach the ultimate
                Truth, bridging spirit and science.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto">
            ...
            <div className="text-center mb-[57px]">
              ...
              <h2 className="mt-[14px] text-white text-[24px] sm:text-[32px] md:text-[42px] leading-[32px] sm:leading-[40px] md:leading-[52px] font-semibold">
                Honoring Kashmir’s legacy, uniting spirituality, science, &
                global progress.
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px]">
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Seeking global recognition of Kashmir's spiritual and
                    scientific heritage, blending ancient wisdom with modernity.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Inspiring future generations to explore the harmony between
                    spirituality and science, ensuring lasting cultural
                    preservation.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Fostering a balanced, ethical approach to modern challenges,
                    drawing from ancient wisdom for global impact.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="relative">
                  <div className="text-left mb-8">
                    ...
                    <p className="text-base sm:text-lg text-gray-700">
                      The Centre seeks to integrate Sufi spiritual practices
                      with modern science, showing how these two realms
                      complement each other. By studying quantum physics, sacred
                      geometry, and consciousness, it aims to create a unified
                      approach to understanding the mysteries of existence and
                      reality’s true nature. Sufi teachings focus on the
                      inherent goodness of all people, promoting love and
                      understanding beyond religious and cultural divides.
                    </p>
                  </div>
                  <ul className="space-y-6 sm:space-y-8 lg:space-y-10">
                    ...
                    <li className="relative flex items-center p-6 py-6 md:py-8 bg-white rounded-lg shadow-md  transition-all duration-500  hover:-translate-y-[10px] group">
                      ...
                      <div className="ml-4 sm:ml-6">
                        ...
                        <p className="text-sm sm:text-base text-gray-700 transition-colors duration-500 ">
                          Encourage collaboration between mystics & scientists.
                        </p>
                      </div>
                    </li>
                  </ul>
        ...
        <section className="text-left-mobile relative block bg-fixnix-darkpurple py-[120px] z-[1] ">
          ...
          <div className="container mx-auto">
            ...
            <div className="text-center mb-[57px]">
              ...
              <h2 className="mt-[14px] text-white text-[24px] sm:text-[32px] md:text-[42px] leading-[32px] sm:leading-[40px] md:leading-[52px] font-semibold">
                Raising global awareness of Kashmir’s Sufi scholars’ spiritual &
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px]">
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    The Centre highlights Kashmir's Sufi scholars’ contributions
                    globally, fostering international research and
                    collaboration.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Kashmiri Sufi teachings address modern ethical,
                    environmental, and peace-related challenges, offering
              ...
              <div className="relative flex items-center bg-[#ffff]  p-[20px] sm:p-[26px] rounded-[6px] mb-[20px] lg:mb-[30px]  transition-transform duration-[500ms] hover:-translate-y-[10px] group hover:bg-fixnix-lightpurple">
                ...
                <div className="ml-[20px] sm:ml-[20px]">
                  ...
                  <p className="text-fixnix-lightpurple group-hover:text-white sm:text-[16px]">
                    Cultural exchanges promote understanding between science and
                    spirituality, guiding towards a harmonious global future.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center relative block mt-[-6px] mb-[40px] sm:mb-[49px] z-[1]">
              ...
              <h2 className="mt-[10px] sm:mt-[14px] text-fixnix-darkpurple text-[24px] sm:text-[32px] md:text-[42px] leading-[32px] sm:leading-[40px] md:leading-[52px] font-semibold">
                Join us in uncovering the profound mysteries that await
              </h2>
              ...
              <p className="pt-[15px] sm:pt-[20px] text-gray-600 text-[14px] sm:text-[16px] md:text-[18px] leading-[22px] sm:leading-[26px] md:leading-[30px]">
                At the Sufi Science Centre - Kashmir Chapter, we are more than
                just seekers of knowledge—we are travelers on a sacred journey.
                <br className="hidden md:block" />
                This journey calls us to rediscover the wisdom embedded within
                the very fabric of existence, to heal and transform ourselves,{" "}
                <br className="hidden md:block" />
                and to create a lasting impact on the world. As we walk this
                path, we are guided by the timeless light of the Divine.
              </p>
              ...
              <h2 className="mt-[10px] sm:mt-[14px] text-fixnix-darkpurple text-[16px] sm:text-[18px] md:text-[20px] leading-[30px] sm:leading-[40px] font-semibold">
                A space where the divine mysteries of the universe are revealed
                through the pure lens of Sufi wisdom.
              </h2>
            </div>
          </div>
        </section>
