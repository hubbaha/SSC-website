...
export default function Home() {
        ...
        <div className="w-full lg:w-7/12 xl:w-1/2 py-8 lg:py-5 lg:pl-12 xl:pl-24">
          <div className="relative">
            <div className="text-left mb-8">
              ...
              Welcome to the heart of Sufi Science, where sacred wisdom and science converge to reveal existence’s mysteries. The Sufi Science Center – Kashmir Chapter invites you on a transformative journey, blending Sufism’s timeless wisdom with modern discoveries, exploring divine truths that permeate both seen and unseen realms.
              </p>
            </div>
            <ul className="space-y-6 sm:space-y-8 lg:space-y-10">
              ...
              <li className="relative flex items-center p-6 py-6 md:py-8 bg-white rounded-lg shadow-md  transition-all duration-500 hover:-translate-y-[10px] group">
                ...
                <div className="ml-4 sm:ml-6">
                  ...
                  <p className="text-sm sm:text-base text-gray-700 transition-colors duration-500 ">
                  Science, Sufism, consciousness, harmony. </p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="relative block">
            ...
            Sufi Spirituality and Mysticism
             ...
             Love Awakening of Divine 
              ...
              <p className="text-base sm:text-lg text-gray-700">
              In Kashmir, where sacred mountains meet pristine lakes, Sufi spirituality invites divine experience. This path explores mysticism, focusing on love and oneness. Learn from masters, discover spiritual purification stages (Tazkiyah), and practice dhikr.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row bg-gray-100 p-0 pb-[52px] mb-[110px] relative z-10">
            ...
            <div className="md:w-1/2 lg:w-7/12 pt-[123px] relative">
                <div className="mb-[24px]">
                    <h4 className="text-[30px] font-semibold leading-[40px]  mb-[14px]">Divine patterns in nature & science</h4>
                    <p>Exploring divine patterns connecting spirituality, nature, and modern quantum physics.</p>
                </div>
                <ul className="space-y-[17px] pb-[17px]">
    <li className="flex justify-between border-b border-gray-300 pb-[17px]">
        <div>
            <h5 className="text-[24px] font-semibold leading-[34px] text-fixnix-lightpurple mb-[14px]">Sufi Geometry</h5>
            <p>Understanding divine order reflected in nature’s harmonious and sacred patterns.</p>
        </div>
    </li>
    <li className="flex justify-between border-b border-gray-300 pb-[17px]">
        <div>
            <h5 className="text-[24px] font-semibold leading-[34px] text-fixnix-lightpurple mb-[14px]">Kashmiri Beauty</h5>
            <p>Exploring sacred geometry in Kashmir’s art, architecture, and landscapes.</p>
        </div>
    </li>
    <li className="flex justify-between border-b border-gray-300 pb-[17px]">
        <div>
            <h5 className="text-[24px] font-semibold leading-[34px] text-fixnix-lightpurple mb-[14px]">Quantum Patterns</h5>
            <p>Bridging spirituality and science through cosmic structures and mathematical harmony.</p>
        </div>
    </li>
    <li className="flex justify-between border-b border-gray-300 pb-[17px]">
        <div>
            <h5 className="text-[24px] font-semibold leading-[34px] text-fixnix-lightpurple mb-[14px]">Spiritual Nature</h5>
            <p>Sacred patterns reveal deep connections between divinity and universal laws.</p>
        </div>
    </li>
</ul>
        ...
        <div className="flex flex-col md:flex-row pl-5 bg-gray-100 p-0 pb-[52px] mb-[110px] relative z-10">
            <div className="md:w-1/2 lg:w-7/12 pt-[123px] relative">
                <div className="mb-[24px]">
                    ...
                    <p>Understanding the soul’s path back to the divine source.</p>
                </div>
                <ul className="space-y-[17px] pb-[17px]">
    <li className="flex justify-between border-b border-gray-300 pb-[17px]">
        <div>
            <h5 className="text-[24px] font-semibold leading-[34px] text-fixnix-lightpurple mb-[14px]">The Soul’s Journey</h5>
            <p>Understanding the soul’s evolution, purpose, and return to divine unity.</p>
        </div>
    </li>
    <li className="flex justify-between border-b border-gray-300 pb-[17px]">
        <div>
            <h5 className="text-[24px] font-semibold leading-[34px] text-fixnix-lightpurple mb-[14px]">Nafs and Purification</h5>
            <p>Refining the self through discipline, spiritual practices, and inner transformation.
</p>
        </div>
    </li>
    <li className="flex justify-between border-b border-gray-300 pb-[17px]">
        <div>
            <h5 className="text-[24px] font-semibold leading-[34px] text-fixnix-lightpurple mb-[14px]">Expanding Consciousness</h5>
            <p>Unlocking human potential through meditation, prayer, and heightened awareness.</p>
        </div>
    </li>
    <li className="flex justify-between border-b border-gray-300 pb-[17px]">
        <div>
            <h5 className="text-[24px] font-semibold leading-[34px] text-fixnix-lightpurple mb-[14px]">Union with the Divine</h5>
            <p>Attaining enlightenment through devotion, self-awareness, and divine connection.</p>
        </div>
    </li>
</ul>
  ...
  <div className="container">
    <div className="relative block">
      ...
      As Kashmir has long been a center of spiritual learning, it is our mission to extend the knowledge of Sufi science to the global community. This learning path invites you to participate in international dialogues, conferences, and collaborations where Sufi scholars and modern scientists can come together to explore the confluence of the mystical and the scientific. By sharing our insights with the world, we contribute to the global understanding of the unity of existence and the path of spiritual enlightenment.
      </p>
      </div>
    </div>
  </div>
  ...
  <div className="container">
    <div className=" text-center mb-[49px]">
      ...
      Exploring the integration of ancient Sufi wisdom with modern scientific knowledge, this path empowers individuals to navigate both the spiritual and material worlds, fostering a deeper understanding of life, consciousness, and the universe.
      </p>
    </div>
      ...
      <div className="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
        <div className=" relative block bg-white shadow-[0_8px_29px_0_rgba(0,0,0,0.1)] mb-[30px] z-[2]">
          ...
          <div className=" p-[22px] pb-[30px]">
            ...
            Bringing together Sufi teachings and modern scientific knowledge for holistic understanding.</p>
          </div>
        </div>
      </div>
      ...
      <div className="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
        <div className=" relative block bg-white shadow-[0_8px_29px_0_rgba(0,0,0,0.1)] mb-[30px] z-[2]">
          ...
          <div className=" p-[22px] pb-[30px]">
            ...
            <p className=" mt-[15px] mb-[22px]">
            Offering workshops, lectures, and courses combining spirituality with scientific exploration and practice.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
        <div className="relative block bg-white shadow-[0_8px_29px_0_rgba(0,0,0,0.1)] mb-[30px] z-[2]">
          ...
          <div className="p-[22px] pb-[30px]">
            ...
            <p className=" mt-[15px] mb-[22px]">
            Empowering seekers to unite divine reverence with intellectual curiosity for deeper wisdom.
            </p>
          </div>
        </div>
      </div>
