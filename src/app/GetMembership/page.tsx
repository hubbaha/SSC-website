  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-2xl bg-white shadow-lg rounded-xl p-6">
        <h2 className="text-2xl font-semibold text-center text-gray-800">Membership Form</h2>
        <h3 className="text-lg font-semibold text-gray-700 mt-4">Personal Information</h3>
        <form onSubmit={handleSubmit} className="mt-4">
          {[
            ...
            <div key={field.name} className="relative mb-4">
              ...
              />
              <label
                className="absolute left-3 top-2 text-gray-500 text-sm transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:top-0 peer-focus:text-xs peer-focus:text-blue-500"
              >
