...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={3} footerStyle={4} breadcrumbTitle="Contact Us">
        {/*Contact Page Start*/}
                                ...
                                <div className="row">
                                    <div className="col-xl-12">
                                        ...
                                        <div className="contact-page__btn-box">
                                            <Link href="about" className="thm-btn contact-page__btn">Send Message</Link>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div className="col-xl-6 col-lg-6">
                        <div className="contact-page__right">
                            <div className="section-title text-left">
                                ...
                                <h2 className="section-title__title">Visit one of our agency
                                    <br/> contact us today</h2>
                            </div>
                            <p className="contact-page__right-text">Duis aute irure dolor in repreh enderit in volup tate
                                cillum dolore eu fugiat nulla dolor atur with Lorem ipsum is simply free market web
