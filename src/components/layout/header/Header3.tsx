              ...
              <div className="main-menu-two__wrapper-inner">
                ...
                <div className="main-menu-two__right">
                  <div className="main-menu-two__main-menu-box">
                    <Link href="#" className="mobile-nav__toggler" onClick={handleMobileMenu} aria-label="Toggle Mobile Menu">
                  ...
                  <div className="main-menu-two__search-cart-btn-box">
                    <div className="main-menu-two__search-box">
                      <Link href="#" className="main-menu-two__search search-toggler icon-search-interface-symbol" onClick={handlePopup} aria-label="Search"></Link>
                    </div>
                    <div className="main-menu-two__cart-box">
                      <Link href="cart" className="main-menu-two__cart fas fa-shopping-cart" aria-label="Go to Cart"></Link>
                    </div>
                    <div className="main-menu-two__btn-box">
                      <Link href="ppointment" className="thm-btn main-menu-two__btn">Book A Service</Link>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="main-menu-two__wrapper-inner">
                  ...
                  <div className="main-menu-two__right">
                    ...
                    <div className="main-menu-two__search-cart-btn-box">
                      ...
                      <div className="main-menu-two__cart-box">
                        <Link href="/Contact" className="main-menu-two__cart fas fa-shopping-cart" aria-label="Go to Cart"></Link>
                      </div>
                      <div className="main-menu-two__btn-box">
                        <Link href="/Conferences" className="thm-btn main-menu-two__btn">Book A Service</Link>
                      </div>
                    </div>
                  </div>
                </div>
