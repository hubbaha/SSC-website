                        ...
                        <div className="blog-one__single">
                            ...
                            <div className="blog-one__content">
                                <ul className="blog-one__meta list-unstyled">
                                    ...
                                    <li>
                                        <Link href="/Donations"><i className="far fa-comments"></i>02 COMMENTS</Link>
                                    </li>
                                </ul>
                    ...
                    <div className="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div className="blog-one__single">
                            ...
                            <div className="blog-one__content">
                                ...
                                <h3 className="blog-one__title"><Link href="Donations">How To Fix Broken Screen On Your
                                        Laptop</Link></h3>
                                <div className="blog-one__btn-box">
                                    <Link href="/Donations" className="thm-btn blog-one__btn">Read More</Link>
                                </div>
                    ...
                    <div className="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div className="blog-one__single">
                            ...
                            <div className="blog-one__content">
                                ...
                                <h3 className="blog-one__title"><Link href="/Donations">What Is The Best Affordable
