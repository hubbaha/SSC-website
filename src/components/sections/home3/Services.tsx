                ...
                <div className="row">
                        ...
                        <div className="services-three__single">
                            <div className="services-three__img-box">
                                ...
                                <div className="services-three__hover-content">
                                    <p className="services-three__hover-text">There are many variations of passages of Lorem
                                        Ipsum available, but the majority</p>
                                    <div className="services-three__btn-box">
                                        <Link href="/Conferences" className="services-three__btn thm-btn">read
                                            more</Link>
                                    </div>
                                </div>
                            </div>
                            <h3 className="services-three__title"><Link href="/Conferences">Laptop Repair</Link>
                            </h3>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div className="services-three__single">
                            ...
                            <h3 className="services-three__title"><Link href="/Conferences">Smart Phone Repair</Link>
                            </h3>
                        </div>
                    </div>
                    {/*Services Three Single End*/}
                    ...
                    <div className="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div className="services-three__single">
                            ...
                            <h3 className="services-three__title"><Link href="/Conferences">Mac Repair</Link>
                            </h3>
                        </div>
                    </div>
                    {/*Services Three Single End*/}
